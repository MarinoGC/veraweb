...
$title2 = $ext1['title2'];
$inhoud = $ext1['inhoud'];
$pictSel = $ext1['pictName'];

//in grote lijnen readMDtot2.php, echter de bewuste MD-file wordt aangepast
...
//hier wordt ook de bewuste MD-file herzien
...
//hier de aanpassing om de nieuwe data op te nemen________________________________________

            if ($cc['pictname'] == $pictSel) {
                $cc['title1'] = $title1;
                $cc['title2'] = $title2;
                $cc['inhoud'] = $inhoud;
            }
